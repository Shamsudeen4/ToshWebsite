  ...
  return (
    <div className='lg:flex flex-col lg:items-center gap-[100px] font-raleway lg:mt-20 sm:mt-20 sm:mb-20'>
        ...
        <div className=' flex-col  gap-4 flex sm:text-center sm:items-center'>
            ...
            <p className='lg:w-[34vw] text-[#00000099] font-semibold sm:w-[85vw]'>We Are Committed To Delivering Exceptional Service 
            And Quality Products In Website Design, Web Development, App Development, And 
            All Aspects Of Software Development, While Also Providing Accessible And 
            Comprehensive Training To Help People Transition To Tech Careers
            </p>
        </div>
