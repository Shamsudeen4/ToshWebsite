  ...
  return (
    ...
    <div className=' flex flex-col gap-20 items-start justify-center lg:m-44 sm:m-12 sm:text-center'> 
      <div className='flex flex-col gap-3'>
        ...
        We help in building and maintaining high-quality websites 
        for law firms that increases brand exposure , attract your 
        ideal clients and gives a good lasting impression. Given our 
        7 years of expertise in this field, we have proven tracks and 
        records that enables us to remain reliable and exceptional. 
        Below are some of our works and products
      </h4>
