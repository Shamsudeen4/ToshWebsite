  ...
  return (
    ...
    <div className=' flex flex-col gap-20 items-start justify-center lg:m-44 sm:m-12 sm:text-center'> 
      <div className='flex flex-col gap-3'>
        ...
        We help Neurosurgeons increase their searchability and discoverability with our 
        versatile software solutions and SEO practices. Additionally, we ensure to 
        include patient scheduling software that allows patients to book appointments 
        easily.
      </h4>
