...
function Cfourth() {
  return (
        ...
        <div className='  flex flex-col justify-center items-center w-[100%] 2xl:h-[50vh] sm:h-[50vh] bg-[white]'>
          <div className=' flex flex-col gap-6 items-center justify-center bg-[#C12DC1] py-[50px] px-[300px] rounded-[20px] sm:rounded-none sm:px-9 text-center'>
            <h1 className='font-raleway text-[white] text-[30px] font-bold sm:text-[25px]'>HAVE ANY QUESTIONS?</h1>
            ...
            <button className='bg-[white] px-[30px] py-[10px]  text-[#C12DC1] rounded-[10px] border-[2px] border-[white] hover:text-[white] hover:bg-[#C12DC1]   duration-300'>Contact Us</button>
          </div>
        </div>
