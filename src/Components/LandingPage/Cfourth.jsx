...
function Cfourth() {
  return (
        ...
        <div className='  flex flex-col justify-center items-center w-[100%] 2xl:h-[100vh] sm:h-[50vh] bg-[white]'>
          <div className=' flex flex-col gap-6 items-center justify-center bg-[#C12DC1] py-[50px] px-[300px] rounded-[20px] sm:rounded-none sm:px-9 text-center'>
            ...
            <button className='bg-[white] px-[30px] py-[10px]  text-[#C12DC1] rounded-[10px] '>Contact Us</button>
          </div>
        </div>
