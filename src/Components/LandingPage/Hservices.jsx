  ...
  return (
    ...
    <div className=' flex flex-col gap-20 items-start justify-center lg:m-44 sm:m-12 sm:text-center'> 
      <div className='flex flex-col gap-3'>
        ...
        <h4 className='lg:w-[42vw] sm:w-[80vw]'>
      ...
      <div className='flex flex-col items-end gap-20 sm:gap-11 sm:items-center'>
        ...
        <div>
            <a href="/service"><button className='bg-[#FB9B02] text-[white] py-3 px-8 rounded-[15px] border-[2px] border-solid border-[#FB9B02] hover:text-[#FB9B02] transition duration-500 hover:bg-transparent'>View All Services</button></a>
        </div>
      </div>
    </div>
    </div>
