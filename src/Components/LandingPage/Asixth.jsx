...
function Asixth() {
  return (
    ...
    <div className='flex flex-col lg:gap-20 sm:gap-[30px] items-center justify-center  w-[100%] lg:h-[100vh]  sm:p-11'>
      <div className='lg:pt-32  flex flex-col gap-5 text-center items-center '>
      ...
      <div className='flex flex-col items-end justify-center gap-16 sm:items-center sm:gap-8'>
  ...
  >
    ...
    <SwiperSlide>     
      <div className='flex flex-col gap-8 bg-[white] p-[70px] rounded-[10px] sm:rounded-[15px] sm:px-[50px] sm:py-[40px]  '>
        ...
        <div>
            <a href="/home" className='text-[#C12DC1] font-poppins font-semibold underline decoration-[#C12DC1]'>View All Reviews</a>
        </div>
      </div>
