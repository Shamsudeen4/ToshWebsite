...
function Mdcontac() {
  return (
    <div className=' gap-[40px] font-raleway items-center justify-center flex flex-col w-[100%] h-[100vh] '>
      <div className='pr-[530px]'>
        <h1 className='font-bold text-[30px]'>Contact Notification</h1>
        <h4 className='font-semibold text-[18px] text-[#00000080] '>Home {'>'} Contact</h4>
      </div>
