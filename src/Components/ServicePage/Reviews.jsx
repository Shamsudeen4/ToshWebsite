...
function Hreviews() {
  return (
    ...
    <div className='flex flex-col lg:gap-20 sm:gap-[40px] items-center justify-center  w-[100%] h-[100vh] sm:h-[90vh] '>
      <div className='lg:pt-32 flex flex-col gap-5 text-center items-center '>
        <h1 className='font-raleway font-semibold text-[30px] sm:text-[25px] sm:font-semibold'>What Our Client Are Saying</h1>
      ...
      <div className='flex flex-col items-end justify-center gap-16 sm:items-center sm:gap-16'>
