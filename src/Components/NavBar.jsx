...
function NavBar() {
  ...
  return (
    ...
    <div className='navbar flex items-center justify-around py-5 '>
      ...
      <div>
        <button className='bg-[#FB9B02] px-6 py-3 rounded-[14px] text-[white]   hover:bg-[white] hidden 2xl:block  hover:text-[#FB9B02] border-[1px] border-solid border-[#FB9B02] transition duration-200'>Apply Now</button>
      </div>
      <div className={`2xl:hidden cursor-pointer`} onClick={toggleNav}>
