...
function Hreviews() {
  return (
    ...
    <div className='flex flex-col lg:gap-20 sm:gap-[30px] items-center justify-center  w-[100%] lg:h-[100vh] sm:py-8 '>
      <div className='lg:pt-32 flex flex-col gap-5 text-center items-center '>
        <h1 className='font-raleway font-semibold text-[30px] sm:text-[25px] sm:font-semibold sm:w-[60vw]'>What Our Students Are Saying</h1>
      ...
      <div className='flex flex-col items-end justify-center lg:gap-16 sm:items-center sm:gap-[20px]'>
